...
- `assets/` — tudo vendorizado, **zero JS de CDN em runtime** (o deck prega isso):
  ...
  - `ufba-erro.png` — screenshot real do erro no Wi-Fi da UFBA; `remote-celular.png` — print do remoto conectado (viewport iPhone 390×844 @3x, capturado headless com o fluxo real: p2p, slide 02/35, laser ligado); `tela-qr.png` — print da tela do deck com o painel do R aberto (1440×900 @2x, broker conectado, status "aguardando o celular…"; URL/código são de uma sessão local); `logo-branca.png`
